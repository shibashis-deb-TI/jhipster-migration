...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '5fbfc826-08e8-4086-aeec-5976a13c2ddd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2a5bba08-87e0-4694-a5e1-6da7a7996342');
      cy.get(`[data-cy="name"]`).should('have.value', '2a5bba08-87e0-4694-a5e1-6da7a7996342');
